...
<div region="center" class="easyui-layout" style="border:0">
    <div region="north" style="height:70px;;border:0;padding:0px" id="search">
	    ...
	    <legend>查询条件</legend>        
            ...
            <label style="margin-left:10px">培训开始时间:</label><input class="easyui-datebox" name="train_date_start" db_field="infoTrain.train_date_start"  />                      
            <label style="margin-left:10px">培训结束时间:</label><input class="easyui-datebox" name="train_date_end" db_field="infoTrain.train_date_end"  />  
    ...
    <div region="center"  style="border:0;width:98%;padding:0px">
        <div class="easyui-layout" style="height:100%;width:100%;margin:0 auto" >
        	<div region="center" title="培训信息" style="border:0;width:60%;padding:0px">
...
<script type="text/javascript" src="js/trainMan.js"></script>
